...
public class EnemySpawner : MonoBehaviour
{
    ...
    {
        while (totalSpawned < maxTotalSpawned)
        {
            SpawnEnemy();
        ...
        Debug.Log("Spawner stopped. Global max reached.");
    }
    ...
    void SpawnEnemy()
    {
        ...
        if (totalSpawned >= maxTotalSpawned)
            return;
        ...
        {
            Debug.Log("All spawn points currently full.");
            return;
        }
